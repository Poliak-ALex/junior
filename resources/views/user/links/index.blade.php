        ...
        <div class="col-md-12">
            <div class="card">
                <h2 class="card-header bg-secondary text-white">
                    My URL
                    <a class="btn btn-success" style="position: absolute; top: 20%; right: 1%;" href="{{ route('link.create') }}"> <i class="fas fa-plus"></i> Add New URL</a>
                </h2>
                <div class="card-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Link Delet</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <!-- Modal body -->
            <div class="modal-body">
                <h4>Are you sure want to delete this Link?</h4>
            </div>
            <!-- Modal footer -->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('body').on('click', '#getEditLinkData', function(e) {
            ...
            $('.alert-danger').hide();
            id = $(this).data('id');
            document.location.href = "link/"+id+"/edit";
        });
