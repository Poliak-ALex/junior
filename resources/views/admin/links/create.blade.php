        ...
        <div class="col-md-12">
            <div class="card">
                <h2 class="card-header bg-secondary text-white">
                    Generate New Link
                    <a class="btn btn-primary" style="position: absolute; top: 20%; right: 1%;" href="{{ url()->previous() }}"> Back</a>
                </h2>
                <div class="card-body">  
                    <form action="{{ route('links.store',$userId) }}" method="POST">
                        @csrf
                        <div class="row" style="padding-left:8px;padding-right:8px;">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6"> 
                                ...
                                <input type="text" name="primary_link" maxlength="250" class="form-control {{ $errors->has('primary_link') ? 'is-invalid' : '' }}"
                                       value="{{ old('primary_link') }}" placeholder="Url" autofocus >
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6"> 
                                ...
                                <div class="input-group has-validation" bis_skin_checked="1">
                                    ...
                                    <input type="text" name="generated_link" id="generated_link" maxlength="250" class="form-control {{ $errors->has('generated_link') ? 'is-invalid' : '' }}"
                                           value="{{ old('generated_link') }}" placeholder="Enter or Generate url" oninput="verify(this.value)">
